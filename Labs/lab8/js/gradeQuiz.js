$(document).ready(function(){
    ...
    $("form").submit(function(event) {
        ...
        var answer3 = parseInt($("input[name='question3']").val());
        ...
        $("#question3-feedback").append("The answer is <strong>525 </strong>");
        // Question 4
        if(answer4 === "A") {
        ...
        $("#question4-feedback").append("The answer is <strong>Fort Ord</strong>");

        //Displays quiz score
        $("#score").html(score);
        $("#waiting").html("<img src='img/loading.gif' alt='sumbitting data' />");
