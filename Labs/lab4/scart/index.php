<?php
    ...
    if (isset($_POST['itemName'])) {
        ...
        // I think we put this here
        // Check to see if other items with this id are in the array. If so, this
        // item isn't new. Only update quantity. Must be passed by reference so
        // that each item can be updated!
